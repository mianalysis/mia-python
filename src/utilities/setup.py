...
def setup(ij):
    ...
    VolumeFactories = jimport(
        "io.github.mianalysis.mia.object.coordinates.volume.VolumeFactories"
    )
    ...
    CoordinateSetFactories = jimport(
        "io.github.mianalysis.mia.object.coordinates.volume.CoordinateSetFactories"
    )
    ...
    MeasurementFactories = jimport(
        "io.github.mianalysis.mia.object.measurements.MeasurementFactories"
    )
